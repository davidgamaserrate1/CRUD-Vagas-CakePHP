...
<div class="row">
    <aside class="column" >
    <div class="side-nav" style="background-color: white; border-radius: 15px; width:260px; height: 160px;">
    <div>
        <div class="container" > <br>
                <a href="http://localhost/vagascake/departamentos/add" >Criar Departamento</a> <br>
                <a href="http://localhost/vagascake/empresas/add">Criar Empresa</a> <br>
                <a href="http://localhost/vagascake/estabelecimentos-empresas/add"> Criar Estabelecimento  </a>
        </div>
